                ...
                <div className={styles.modernization}>
                    ...
                    <div className={styles["modernization-container"]}>
                        <div className={styles.text}>
                            <h2>
                                Transform Digital Consumer Experience With
                                Prodevans Access
                            </h2>
                            <p>
                                Prodevans customer experience fuels better
                                engagement and drives revenue and loyalty. It
                                is, therefore, essential for your CIAM to
                                deliver convenience, hyper-personalization, and
                                security tightly coupled to revamp your digital
                                customer experience.Create a homogenous, single
                                view of your consumer from across disparate user
                                stores within your enterprise and offer
                                consistent, multi-channel personalization with
                                risk-score backed, adaptive multi-factor
                                authentication.Deployed across cloud,
                                on-premises, or hybrid IT environments,
                                future-proof your enterprise by boosting the
                                agility and scalability of its consumer identity
                                access management capabilities with Prodevans
                                CIAM.
                            </p>
                        </div>
