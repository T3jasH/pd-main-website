...
export default function Infrastructure({ toggleNav }) {
    ...
    return (
        <React.Fragment>
            ...
            {!isOpen ? (
                <div
                    className={`${styles.modernization} ${styles.infrastructure}`}
                >
                    <NavPath
                        main={"Services"}
                    ...
                    <div className={styles["modernization-container"]}>
                        <div className={styles.text}>
                            <p>
                                ...
                                software, hardware, network resources and
                                services required for the management, operation
                                and existence of an enterprise IT environment.
                                High availability, responsiveness and
                                reliability of the IT infrastructure are
                                important to meet the dynamic needs of the
                                business.
                            </p>
                            <p>
                                We manage your infrastructure using enterprise
                                automation, infrastructure automation,
                                application automation, security and compliance
                                automation. We connect infrastructure, services
                                and suppliers to have an integrated solution
                                across all the operations. We enable the end
                                user to scale up or down the resources. We uses
                                Cloud orchestration technologies like openstack,
