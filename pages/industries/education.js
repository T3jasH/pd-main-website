...
export default function Education({ toggleNav }) {
                ...
                <div className={styles.industries}>
                    <div className={styles["industries-img"]}>
                        ...
                        <p>
                            ...
                            especially crafted for Educational Institutions. It
                            has Pre Configured private cloud platform on
                            OpenStack for Compute, Network &#38; Storage.
                            PDCloudEx comes with an Initial set up with one
                            server that can be scaled up or down on demand.
                        </p>
                    </div>
                        ...
                        <div className={styles.left}>
                            ...
                            <ul>
                                <li>
                                    ...
                                    Machines using the Service Catalog by the
                                    click of a button.
                                </li>
                                <li>
                                    Using PDcloudEX, Prodevans will set up
                                    customized lab as per the requirements.
                                    Students will find it very easy to complete
                                    their lab assignments.
                                </li>
                                <li>
                                    Most Educational institutes need scalable
                                    Infrastructure setup. PDCloudEx provides
                                    just that
                                </li>
                                <li>
                                ...
                                <li>
                                    PDCloudEx is integrated with WebRTC, which
                                    is a software that provides Video/Audio
                                    Conference Call.
                                </li>
                            </ul>
                        </div>
