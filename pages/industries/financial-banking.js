            ...
            <div className={styles.industries}>
                ...
                <div className={`${styles["healthcare-container"]}`}>
                    <div className={styles.left}>
                        ...
                        <p>
                            Container Technology is very quickly changing how
                            organizations deploy application workloads - be it
                            on-prem or public cloud.{" "}
                        </p>
                        <p>
                            Through all this, Kubernetes has emerged as the
                            de-facto deployment &#38; orchestration platform for
                            managing container workloads advantages.
                        </p>
                        <p>
                        ...
                        <p>
                            There is a steep learning curve for organizations -
                            to to cut through this landscape to take
                            applications to production and thereafter, to
